...
export const SelectorTextarea = '[data-testid="tweetTextarea_0"]'
export const SelectorAttachments = '[data-testid="attachments"]'
export const SelectorCardWrapper = '[data-testid="card.wrapper"]'
